package com.upnet.iot.module.system.controller.admin.socail.vo.client;
...
import com.upnet.iot.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "upnet商城")
