package com.upnet.iot.module.system.service.social;
...
import com.upnet.iot.framework.common.util.cache.CacheUtils;
import com.upnet.iot.framework.common.util.http.HttpUtils;
import com.upnet.iot.framework.common.util.object.BeanUtils;
import com.upnet.iot.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.upnet.iot.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.upnet.iot.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.upnet.iot.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.upnet.iot.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.upnet.iot.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.upnet.iot.module.system.dal.dataobject.social.SocialClientDO;
import com.upnet.iot.module.system.dal.mysql.social.SocialClientMapper;
import com.upnet.iot.module.system.dal.redis.RedisKeyConstants;
import com.upnet.iot.module.system.enums.social.SocialTypeEnum;
import com.upnet.iot.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.upnet.iot.framework.common.util.collection.MapUtils.findAndThen;
import static com.upnet.iot.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.upnet.iot.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.upnet.iot.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${upnet.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${upnet.wxa-subscribe-message.miniprogram-state:formal}")
    ...
    public void uploadWxaOrderShippingInfo(Integer userType, SocialWxaOrderUploadShippingInfoReqDTO reqDTO) {
        ...
        // 对应 ISSUE：https://gitee.com/zhijiantianya/upnet-cloud/pulls/230
