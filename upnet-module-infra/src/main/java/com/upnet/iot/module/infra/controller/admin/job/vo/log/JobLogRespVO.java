package com.upnet.iot.module.infra.controller.admin.job.vo.log;
...
import com.upnet.iot.module.infra.enums.DictTypeConstants;
...
public class JobLogRespVO {
    ...
    @Schema(description = "处理器的参数", example = "upnet")
