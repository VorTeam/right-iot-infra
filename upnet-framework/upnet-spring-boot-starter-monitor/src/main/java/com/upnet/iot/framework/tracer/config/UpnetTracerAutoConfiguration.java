...
import com.upnet.iot.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "upnet.tracer", value = "enable", matchIfMissing = true)
public class UpnetTracerAutoConfiguration {
