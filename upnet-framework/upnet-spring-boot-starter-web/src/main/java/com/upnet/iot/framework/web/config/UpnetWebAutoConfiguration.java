package com.upnet.iot.framework.web.config;
...
import com.upnet.iot.framework.web.core.filter.CacheRequestBodyFilter;
import com.upnet.iot.framework.web.core.filter.DemoFilter;
import com.upnet.iot.framework.web.core.handler.GlobalExceptionHandler;
import com.upnet.iot.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class UpnetWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "upnet.demo", havingValue = "true")
