 ...
 *      1）Spring Async：
 *          {@link com.upnet.iot.framework.quartz.config.UpnetAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 UpnetSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.upnet.iot.framework.tenant;
