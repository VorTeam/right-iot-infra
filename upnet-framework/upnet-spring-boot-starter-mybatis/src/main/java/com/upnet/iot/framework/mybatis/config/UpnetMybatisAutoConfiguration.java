package com.upnet.iot.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import com.upnet.iot.framework.common.util.json.JsonUtils;
import com.upnet.iot.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${upnet.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class UpnetMybatisAutoConfiguration {
