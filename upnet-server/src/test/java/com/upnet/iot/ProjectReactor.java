...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.upnet.iot";
    private static final String ARTIFACT_ID = "upnet";
    private static final String PACKAGE_NAME = "com.upnet.iot";
    private static final String TITLE = "如朋智慧物联系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.upnet.iot";
        String artifactIdNew = "upnet";
        String packageNameNew = "com.upnet.iot";
        String titleNew = "如朋智慧物联系统";
        String projectBaseDirNew = "D:\\Program Files (x86)\\Developer\\Code\\upnet" ; // 一键改名后，“新”项目所在的目录
